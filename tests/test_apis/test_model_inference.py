...
from DBCAN.apis.inference import init_detector, model_inference
...
@pytest.mark.parametrize('cfg_file', [
    # '/home/will/transformer/my_own_code/mmocr/configs/textrecog/robust_scanner/robustscanner_r31_academic.py',
    r"F:\OCR\codes\robust_transformer\configs\textrecog\robust_scanner\robust_trans.py"
])
...
test_model_batch_inference_recog(r'F:\OCR\codes\robust_transformer\configs\textrecog\robust_scanner\robust_adaptive_encoding.py')
# test_model_batch_inference_recog(r"../configs\textrecog\robust_scanner\robustscanner_r31_academic.py")
# test_model_batch_inference_recog(r'F:\OCR\codes\robust_transformer\configs\textrecog\robust_scanner\robust_trans.py')
# test_model_batch_inference_recog('/home/will/transformer/my_own_code/mmocr/configs/textrecog/nrtr/nrtr_r31_1by8_1by4_academic.py')