...
from DBCAN import __version__
from DBCAN.apis import train_detector
from DBCAN.datasets import build_dataset
from DBCAN.models import build_detector
from DBCAN.utils import collect_env, get_root_logger
...
def main():
    ...
    if cfg.checkpoint_config is not None:
        ...
        cfg.checkpoint_config.meta = dict(
            DBCAN_version=__version__ + get_git_hash()[:7],
