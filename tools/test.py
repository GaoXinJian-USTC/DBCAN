...
from DBCAN.apis.inference import disable_text_recog_aug_test
from DBCAN.datasets import build_dataloader, build_dataset
from DBCAN.models import build_detector
from DBCAN.utils import revert_sync_batchnorm


def parse_args():
    parser = argparse.ArgumentParser(
        description='DBCAN test (and eval) a model.')
