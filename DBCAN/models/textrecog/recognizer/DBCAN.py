...
from DBCAN.models.builder import DETECTORS
from .encode_decode_recognizer import EncodeDecodeRecognizer
import warnings
import torch
from DBCAN.models.builder import (DETECTORS, build_backbone, build_convertor,
                                  build_decoder, build_encoder, build_loss,
                                  build_preprocessor)
from .base import BaseRecognizer

@DETECTORS.register_module()
class DBCAN(EncodeDecodeRecognizer):
    """Implementation of `DBCAN."""


@DETECTORS.register_module()
class DBCANTwoStage(BaseRecognizer):
    ...
    def forward_train(self, img, img_metas):
        ...
        out_dec ,out_hybrid = self.decoder(
        ...
        losses_final = self.loss(*loss_inputs)
        losses_hybrid = self.loss(*loss_inputs_hybrid)

        losses = {'loss_ce':losses_final['loss_ce'] + losses_hybrid['loss_ce']}
