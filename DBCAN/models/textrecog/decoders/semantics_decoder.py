...
from DBCAN.models.textrecog.layers import DotProductAttentionLayer
from .base_decoder import BaseDecoder


@DECODERS.register_module()
class SemanticsDecoder(BaseDecoder):
    ...
    def forward_train(self, feat, out_enc, targets_dict, img_metas):
        ...
        # print("hibrid", query.shape, key.shape, value.shape)
